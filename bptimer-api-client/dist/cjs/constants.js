...
exports.MOB_MAPPING = exports.LOCATION_TRACKED_MOBS = exports.HP_REPORT_INTERVAL = exports.CACHE_EXPIRY_MS = void 0;
exports.CACHE_EXPIRY_MS = 5 * 60 * 1000;
exports.HP_REPORT_INTERVAL = 5;
// Mob IDs that require position data for location tracking
exports.LOCATION_TRACKED_MOBS = new Set([10900, 10901, 10904]);
exports.MOB_MAPPING = new Map([
